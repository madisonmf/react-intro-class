...
class Calculator extends Component {
    ...
    let display = ( this.state.display === '0' ) ? num: this.state.display + num;
        this.setState({
            display: (this.state.display < 13) ? display : this.state.display
        })
    }
    ...
    setOperator (operator) {
        if (!this.state.operator) {
            this.setState({
                operator: operator,
                temp: parseInt(this.state.display, 10), display: '0'
            })
        }
    }
        ...
        return (
            <div id="calculator-container">
              ...
              <div id="calculator-mask" className="remove-highlight">
                ...
                <div className="btn clear" onClick={ () => {this.clearDisplay('0')} }></div>
